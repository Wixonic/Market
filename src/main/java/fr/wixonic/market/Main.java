...
public final class Main extends JavaPlugin {
	...
	public boolean setupEconomy() {
		if (this.getServer().getPluginManager().getPlugin("Vault") == null)
			return false;
		RegisteredServiceProvider<Economy> serviceProvider = getServer().getServicesManager()
	...
	public void onEnable() {
		...
		CustomSkull.presets.put("leftArrow", new CustomSkull("Back").setTexture(
		...
		CustomSkull.presets.put("doubleBackward", new CustomSkull("First").setTexture(
		...
		CustomSkull.presets.put("backward", new CustomSkull("Previous").setTexture(
		...
		CustomSkull.presets.put("forward", new CustomSkull("Next").setTexture(
		...
		CustomSkull.presets.put("doubleForward", new CustomSkull("Last").setTexture(
		...
		CustomSkull.presets.put("checkmark", new CustomSkull("Validate").setTexture(
				"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMzdiNjJkMjc1ZDg3YzA5Y2UxMGFjYmNjZjM0YzRiYTBiNWYxMzVkNjQzZGM1MzdkYTFmMWRmMzU1YTIyNWU4MiJ9fX0="));
		// CustomSkull.presets.put("name", new
		// CustomSkull("displayName").setTexture("texture"));
